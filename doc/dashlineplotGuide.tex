...
\include{func} % Functional Description
\include{inout} % Input and Output Data
\include{system} % Operating System, Major Software Versions and Licenses
\include{user} % User-level Description
